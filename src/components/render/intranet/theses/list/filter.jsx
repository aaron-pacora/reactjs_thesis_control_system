...
class Filter extends Component {
    ...
    onEnterDetected(e) {
        if (e.keyCode === 13){
            if(this.title != e.target.value.trim()){
        ...
        return (
            <div class="form_filter">
                ...
                <div class="input-field inp_short">
                    <a class="waves-effect waves-light btn button_save" onClick={this.onSearch}>Buscar</a>
                </div>
                ...
                <div class="input-field inp_short">
                    ...
                    <div className="icon_info tooltipped" data-position="right" data-delay="50" data-tooltip="Necesita dar click en Buscar">
                        <IconInfo/>
                    </div>
                </div>
            </div>
